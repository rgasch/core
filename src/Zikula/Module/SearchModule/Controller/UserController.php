...
class UserController extends \Zikula\Framework\Controller\AbstractController
{
    ...
    public function formAction($vars = array())
    {
        ...
        if (count($search_modules) > 0) {
            ...
            $twigArray['plugin_options'] = $plugin_options;
            $twigArray['title'] = "new title";

            // Return the output that has been generated by this function
            return $this->get('templating')->renderResponse('ZikulaSearchModule:User:form.html.twig', $twigArray);
    ...
    public function searchAction()
    {
        ...
        */
        ...
        $result = ModUtil::apiFunc('SearchModule', 'user', 'search', $vars);
        ...
        if ($vars['firstPage']) {
            ModUtil::apiFunc('SearchModule', 'user', 'log', $vars);
        }
    ...
    public function recentAction()
    {
        ...
        // get the
        $items = ModUtil::apiFunc('SearchModule', 'user', 'getall', array('startnum' => $startnum, 'numitems' => $itemsperpage, 'sortorder' => 'date'));
        ...
        $this->view->assign('pager', array('numitems'     => ModUtil::apiFunc('SearchModule', 'user', 'countitems'),
